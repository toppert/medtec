...
class CreateAccountPatientPage extends StatelessWidget {
  ...
  /// If the call is successful, the function calls the `_onPatientSuccess()` function.
  /// If the call fails, the function calls the `_onPatientError()` function.
  ///
